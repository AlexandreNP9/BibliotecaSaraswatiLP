        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (acao.equals("insert")) {
                    ...
                    try {
                        autor.setFalecimentoAutor(sdf.parse(textFieldNome.getText()));
                    } catch (ParseException ex) {
                        Logger.getLogger(CRUDAutor.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    autor.setImagemAutor(textFieldImagem.getText());
...
//---------------------------------------------------------
        ...
        textFieldSobrenome.addFocusListener(new FocusListener() {
            @Override
        ...
        textFieldNascimento.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                textFieldNascimento.setBackground(Color.GREEN);
            }

            @Override
            public void focusLost(FocusEvent e) {
                textFieldNascimento.setBackground(Color.white);
            }
        });
        textFieldFalecimento.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                textFieldFalecimento.setBackground(Color.GREEN);
            }

            @Override
            public void focusLost(FocusEvent e) {
                textFieldFalecimento.setBackground(Color.white);
            }
        });
        textFieldImagem.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                textFieldImagem.setBackground(Color.GREEN);
            }
